...
def teacher_dashboard():
    ...
    with tab3:
        type3 = "primary" if st.session_state.current_teacher_tab == 'attedance_records' else 'tertiary'
        if st.button('Attendance Records', type =type3, width='stretch', icon=':material/cards_stack:'):
            st.session_state.current_teacher_tab = 'attedance_records'
            st.rerun()
    ...
    if st.session_state.current_teacher_tab == 'attedance_records':
        teacher_tab_attedance_records()
...
def teacher_tab_attedance_records():
